...
<div class="centered">
	...
	<h3  class="memberLogin" align="center">SELLER LOGIN</h3>
	...
	<input style="width: 80%; font-size:16px; align=center" type="email" name="sEmail" placeholder="Email" required>
	</div><br>
	
	<div data-validate="Password is required">
	<i class="material-icons" style="font-size:25px; text-align:center;">lock</i>
	<input style="width: 80%; font-size:16px;" type="password" name="spassw" placeholder="Password" required>
	</div><br>
	...
	<div><center>
	<a class="txt2" href="registerS.jsp">
	Sign up now
	</a></center>
	</div>
